...
class CoachingRequest < ActiveRecord::Base
  attr_accessible :cant_decide, :conterfactual_career_plans, :counterfactual_donation_amount, :counterfactual_donation_target, :current_career_plans, :current_donation_percent, :current_donation_target, :current_situation, :dont_know_options, :email, :name, :other_factors, :questions, :skype, :wants_better_world
