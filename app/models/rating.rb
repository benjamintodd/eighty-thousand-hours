class Rating < ActiveRecord::Base
  ...
  belongs_to :user
  attr_accessible :overall, :original, :practical, :transparent, :persuasive, :accessible, :engaging, :comment, :rubric_comment, :user, :user_id, :blog_post, :blog_post_id, :rating, :privacy
